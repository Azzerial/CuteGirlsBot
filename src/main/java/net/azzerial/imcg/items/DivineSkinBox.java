...
public class DivineSkinBox extends Item {

	@Override
	public String getName() {
		return ("Divine Card Box");
	}

	@Override
	public String getDescription() {
		return ("A divine box which gives you a random card of an owned Idol for your collection.");
	}

	@Override
	public ItemType getItemType() {
		return (ItemType.DIVINE_SKIN_BOX);
	}
